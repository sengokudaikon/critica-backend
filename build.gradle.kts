...
dependencies {
    ...
    implementation("io.ktor:ktor-server-caching-headers-jvm:2.3.0")
    ...
    implementation("io.ktor:ktor-server-metrics-jvm:2.3.0")
    implementation("io.ktor:ktor-server-call-id-jvm:2.3.0")
    ...
    implementation("io.ktor:ktor-server-jvm:2.3.0")
